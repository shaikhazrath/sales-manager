    ...
    return (
        <div className=''>
            <div className=' px-10 py-10 flex justify-center flex-col  items-center gap-4 pt-5'>
                ...
                <Input className='md:w-1/3' placeholder='url eg:- https://www.tenali.ai' type="text" value={url} onChange={e => seturl(e.target.value)} />
                ...
                {loading &&
                    <h1 className="text-xl text-center font-medium flex items-center">
                        <svg className="animate-spin h-5 w-5 mr-3 text-black" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <circle
